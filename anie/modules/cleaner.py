...
from anie import ALLOW_EXCL, CustomCommandHandler, dispatcher
from anie.modules.disable import DisableAbleCommandHandler
from anie.modules.helper_funcs.chat_status import (bot_can_delete,
                                                           connection_status,
                                                           dev_plus, user_admin)
from anie.modules.sql import cleaner_sql as sql
...
Blue text cleaner removed any made up commands that people send in your chat.
 ...
 - `/gignoreblue <word>`*:* globally ignorea bluetext cleaning of saved word across anie.
