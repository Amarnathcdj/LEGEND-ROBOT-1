...
import anie.modules.sql.notes_sql as sql
from anie import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from anie.__main__ import DATA_IMPORT
from anie.modules.helper_funcs.chat_status import user_admin
from anie.modules.helper_funcs.alternate import typing_action

# from anie.modules.rules import get_rules
import anie.modules.sql.rules_sql as rulessql

# from anie.modules.sql import warns_sql as warnssql
import anie.modules.sql.blacklist_sql as blacklistsql
from anie.modules.sql import disable_sql as disabledsql

# from anie.modules.sql import cust_filters_sql as filtersql
# import anie.modules.sql.welcome_sql as welcsql
import anie.modules.sql.locks_sql as locksql
from anie.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("anieBOT{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("anieBOT{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `anie-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("anieBOT{}.backup".format(chat_id))  # Cleaning file
