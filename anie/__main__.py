...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/aniexop/anie-ROBOT)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/aniexop/anie-ROBOT.git)
"""
...
anie_IMG = "https://telegra.ph/file/84b2017bc2f3c90f2e61c.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
anie is hosted on one of Heroku's Servers and doesn't require any donations as of now but \
                    ...
                    [[
                     ...
                     [
                      ...
                      [ 
                        InlineKeyboardButton(
                             text=" ✨ Support ",
                             url="https://t.me/anie_userbot_support"),
                        InlineKeyboardButton(
                             text=" 👨‍💻 Creator ",
                             url="https://t.me/aniex22")
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "anie BOT is now online!")
        except Unauthorized:
            LOGGER.warning(
